...
% their DLT structures, and calculates the errors between the
...
% figures path
figuresPath=[savePath slashY 'calibrationFigures'];
...
if saveDLTpairsLogic  
    saveName=[savePath slashY 'DLTstructPairs.mat'];
    icount=1;
    while exist(saveName,'file')
        saveName=[savePath slashY 'DLTstructPairs(' num2str(icount) ').mat'];
        icount=icount+1;
    end
