...
% edited by Leanne Iannucci, Washington Univeristy in St. Louis, 15 March
% 2020. Dialog box asks user what kind of computer this is being run on in
% order to create folders with slashes in the correct (mac/PC) direction.
% Also added in a few command window displays for better user direction.
...
disp('Select stereo calibration images from one camera or multiple cameras');
...
disp('Select location for saving of DLT parameters');
...
disp('Select the file containing the 3D world points of the calibration target');
...
for icam=indCams
    ...
    if saveDLTParametersLogic
        save([savePath slashY 'DLTstruct_cam_' num2str(icam)],'DLTstructCam');
    end    
